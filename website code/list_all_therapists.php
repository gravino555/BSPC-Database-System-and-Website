...
$query = "SELECT * FROM therapist ORDER BY the_id";

$result = mysqli_query($con,$query);
$numTherapists = mysqli_num_rows($result);
echo "Number of therapists: ".$numTherapists."<br>";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
		...
		$tableHtml = $tableHtml . "<tr><td>" . $row["the_id"] . "</td><td>" . $row["first_name"] . "</td><td>" . $row["last_name"] . "</td><td>" . $status . "</td><td>" . $row["experience"] . "</td></tr>" ;
    }
...
<br/><a href='update_therapist1.php'>Update Therapist Information</a><br/></br>
